...
$(document).ready(function() {
    ...
    function listaTjmaNotices(dataTjma) {
        ...
        for(var i = 0; i < dataTjma.length; i++) {
            ...
            component_tjma += "<a class='text-dark' href='"+dataTjma[i]['link']+"' style='text-decoration:none;'>";
            component_tjma += "<img class='d-block w-50 h-25 p-3 img-fluid float-left rounded-circle' src='"+dataTjma[i]['image']+"' alt='"+dataTjma[i]['texto']+"'>";
            component_tjma += "<span class='data-slide float-left'>"+dataTjma[i]['data']+"</span><br><h3 class='font-weight-bold'>"+dataTjma[i]['texto']+"</h3>";
