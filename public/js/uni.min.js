...
$(document).ready(function() {
    ...
    function listaAllNotices(dataAll) {
        ...
        for(var i = 0; i < dataAll['uniao']['seplan'].length; i++) {
            ...
            component_all += "<img style='width:20% !important;height:20% !important;' class='d-inline-block p-3 img-fluid float-left rounded' src='https://seplan.ma.gov.br/files/2019/10/logo-secretarias-seplan.jpg' alt=''>";
            ...
            component_all += "<small class='align-items-center font-weight-bold'>"+dataAll['uniao']['seplan'][i][0]['texto']+"</small>";
            component_all += "</a>";
            component_all += "</div>";
        }
        ...
        for(var j = 0; j < dataAll['uniao']['tjma'].length; j++) {
            component_all += "<div class='carousel-item'>";
            component_all += "<img style='width:15% !important;height:15% !important;' class='d-inline-block p-3 img-fluid float-left rounded-circle mb-3' src='"+dataAll['uniao']['tjma'][j]['image']+"' alt='"+dataAll['uniao']['tjma'][j]['texto']+"'>";
        ...
        for(var t = 0; t < dataAll['uniao']['tcema'].length; t++) {
            component_all += "<div class='carousel-item'>";
            component_all += "<a class='text-dark' href='"+dataAll['uniao']['tcema'][t]['link']+"' style='text-decoration:none;'>";
            component_all += "<img style='width:15% !important;height:15% !important;' class='d-block img-fluid float-left rounded' src='http://site.tce.ma.gov.br/templates/rt_enigma/images/logo/style2/logo.png' alt='"+dataAll['uniao']['tcema'][t]['texto']+"'>";
