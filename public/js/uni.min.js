...
$(document).ready(function() {
    ...
    function listaAllNotices(dataAll) {
        ...
        for(var mj = 0; mj < dataAll['uniao']['minJus']['original'].length; mj++) {
            ...
            'https://i.ytimg.com/vi/L2K_toQvygM/maxresdefault.jpg', dataAll['uniao']['minJus']['original'][mj]['titulo_link'][1],
        ...
        for(var tc = 0; tc < dataAll['uniao']['tcu']['original'].length; tc++) {
            ...
            'https://portal.tcu.gov.br/portaltcu2017/images/TCU.svg', 'https://portal.tcu.gov.br/imprensa/noticias/'+dataAll['uniao']['tcu']['original'][tc]['link'],
